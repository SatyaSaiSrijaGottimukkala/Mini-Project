...
export default function StartPage() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/*<Button onPress={a} title="GET STARTED"   >GET STARTED</Button>*/}
                <TouchableHighlight onPress={a} style={[styles.buttonContainer,styles.button1]}  >
